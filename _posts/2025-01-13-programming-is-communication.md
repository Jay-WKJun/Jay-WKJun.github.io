...
## 좋은 코드는 좋은 글과 같다. - 네이밍이 중요한 이유

위에서 알아보았듯 코드를 잘 작성하기 위해 소통하는 것도 중요하지만, 코드 그 자체를 잘 작성하는 것도 중요합니다.

코드도 결국 특정 규칙에 맞춰 Text를 적는 행위이기 때문에, 좋은 코드는 좋은 글과 같다고 할 수 있습니다.

소설 중 가장 난해하다고 알려진 소설, 도스토옙스키의 **『카라마조프 가의 형제들』**을 예시로 들어보겠습니다.
...
독자들은 이 이름들이 모두 동일한 인물을 가리킨다는 점을 이해하기 위해 **끊임없이 맥락을 추론**해야 합니다. 이러한 복잡성은 이야기를 따라가는 데 큰 장애물이 됩니다.

"『카라마조프 가의 형제들』"처럼 코드도 동일하게 하나의 개념이나 물체를 지칭하는 명사가 명확하고 일관적이지 않으면 독자들은 끊임없이 맥락을 추론해야 합니다.

따라서 각 프로그램 언어들만의 **컨벤션 네이밍들을 잘 따르고** **도메인 용어들을 명확히 정의**하여 그런 혼란을 줄여야합니다.
...
프로그래밍을 할 때, 매번 컨벤션을 신경쓰면서 하기엔 너무 번거롭습니다.

따라서, 합의된 컨벤션을 도구로 자동화하여 팀원들이 컨벤션을 신경쓰지 않도록 도와주는 도구들이 있습니다.

eslint... prettier...

# 정리

마지막으로 효율적 커뮤니케이션의 장점을 정리해보겠습니다.
...
**불필요한 커뮤니케이션 비용을 줄여 비즈니스 임팩트에 집중, 시장에 insight를 전달할 수 있는 멋진 팀이 되었으면 좋겠습니다.**
